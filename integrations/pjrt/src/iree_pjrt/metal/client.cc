...
MetalClientInstance::MetalClientInstance(std::unique_ptr<Platform> platform)
  ...
  // Must match the platform name JAX selects (JAX_PLATFORMS=iree_metal) and the
  // jax_plugins/iree_metal registration.
...
iree_status_t MetalClientInstance::CreateDriver(iree_hal_driver_t** out_driver) {
