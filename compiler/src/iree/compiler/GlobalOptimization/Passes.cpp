...
void buildGlobalOptimizationPassPipeline(
  ...
  FunctionLikeNest(mainPassManager)
      ...
      // iree-metal (metal-spirv): accumulate bf16/f16 matmuls in f32 (round once) so
      ...
      // IREE_METAL_COOP_NO_UPCAST to restore the scalar bf16-accum behaviour.
      .addPredicatedPass(getenv("IREE_METAL_COOP_NO_UPCAST") == nullptr,
