...
// RUN: not env IREE_METAL_CAUSAL_TRIANGULAR_GRID=1 \
// RUN:   IREE_METAL_CAUSAL_BWD_BOUNDS=1 \
// RUN:   iree-opt --pass-pipeline="builtin.module(func.func(iree-codegen-tile-and-distribute-to-workgroups-using-forall-op))" \
// RUN:   %s -o /dev/null 2>&1 | FileCheck %s

// CHECK: error: 'linalg.matmul' op causal triangular workgroup grid requires the native Apple attention pipeline

func.func @legacy_pipeline(
