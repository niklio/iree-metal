# iree-metal 3.11.0.dev2026080301 — Developer Preview 2
...
- The tested `preview-20260803` profile enables the complete physical Apple
...
includes every raw crossover repetition, case-level results, timings, tolerances,
hashes, manifests, and integrity-checked SQLite stores.
...
`iree-metal-preview-3.11.0.dev2026080301-macos-arm64.tar.gz` bundle and verify its
